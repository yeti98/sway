...
function b(p){for(var u=g,q=0;64>q;q+=4)u[q/4]=p[q]<<24|p[q+1]<<16|p[q+2]<<8|p[q+3];for(q=16;80>q;q++)p=u[q-3]^u[q-8]^u[q-14]^u[q-16],u[q]=(p<<1|p>>>31)&4294967295;p=e[0];var B=e[1],E=e[2],V=e[3],fd=e[4];for(q=0;80>q;q++){if(40>q)if(20>q){var Sa=V^B&(E^V);var Tb=1518500249}else Sa=B^E^V,Tb=1859775393;else 60>q?(Sa=B&E|V&(B|E),Tb=2400959708):(Sa=B^E^V,Tb=3395469782);Sa=((p<<5|p>>>27)&4294967295)+Sa+fd+Tb+u[q]&4294967295;fd=V;V=E;E=(B<<30|B>>>2)&4294967295;B=p;p=Sa}e[0]=e[0]+p&4294967295;e[1]=e[1]+
...
function eh(a,b,c){a=a.f.transaction(b,void 0===c?"readonly":c);return new hh(a)}
...
function Gh(a){return N(this,function c(){var d,e,f;return x(c,function(g){switch(g.f){case 1:return w(g,Bh(),2);case 2:return d=g.g,e=dh(eh(d,["LogsRequestsStore"],"readwrite"),"LogsRequestsStore"),w(g,e.get(a),3);case 3:f=g.g;if(!f){g.F(4);break}f.status="NEW";f.sendCount+=1;return w(g,X(e.f.put(f,void 0)),4);case 4:return g["return"](f)}})})}
...
c=t(c);for(var e=c.next();!e.done;e=c.next())e=e.value.getAsJson(),(jb(e)||!e.trackingParams&&!e.veType)&&fi(Error("Child VE logged with no data"));c={fa:zi(a),S:a};"UNDEFINED_CSN"==a?Ti("visualElementAttached",b,c):d?Og("visualElementAttached",b,d,c):bi("visualElementAttached",b,c)}
