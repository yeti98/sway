...
public class PostService implements IPostService {
    ...
    @Override
    @Transactional
    public PostModel createPost(UpsertPostRequest upsertPostRequest) {
        Post post= new Post();
        ...
        return Entity2DTO.post2DTO(postRepository.save(post));
    }
    ...
    @Override
    public PostModel updatePost(UpsertPostRequest upsertPostRequest, Long idPost) {
