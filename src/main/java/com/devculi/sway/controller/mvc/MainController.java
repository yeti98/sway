...
public class MainController {
    ...
    public String baitapChiTiet(Model model) {
        ...
        swayTestModel.setQuestions(qs.stream().map(Entity2DTO::question2DTO).collect(Collectors.toList()));
...
//        int count = 0;
//        for (QuestionModel question : swayTestModel.getSwayTest().getQuestions()) {
//            if (question.getSelected() == null || !question.getSelected().equalsIgnoreCase(question.getAnswer())) {
...
//            }
//        }
//        int numOfQuestion = swayTestModel.getSwayTest().getNumberOfQuestion();
//        double score = ((double) count * 10) / numOfQuestion;
//        swayTestModel.setScore(score);
//        swayTestModel.setScoreInString(String.format("%s/%s", count, numOfQuestion));
//        swayTestModel.setPassed(swayTestModel.getSwayClass().getMinScore() < score);
//        swayTestModel.setPassed(true);
